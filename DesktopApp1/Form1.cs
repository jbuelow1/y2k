...
namespace DesktopApp1
{
    public partial class Form1 : Form
    {
        ...
        private void Timer1_Tick(object Sender, EventArgs e)
        {
            ...
            if (running)
            {
                ...
                if (!(epoch - pEpoch == 1) && !ErrorShowing && (tick - StartTick > 1))
                {
                    ...
                    running = false;
                    start.Text = "Start";
                    DropThoseMotherfuckingNukesBaby();
                    ErrorShowing = false;
                }
        ...
        public void DropThoseMotherfuckingNukesBaby()
        {
            ...
            */
            ...
            System.Diagnostics.Process.Start("https://www.youtube.com/embed/XrwK-zS2HZ8?start=16&autoplay=1");
        }
